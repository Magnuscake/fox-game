...
const gameState = {
  ...
  die() {
    ...
    (0, _ui.modFox)('dead');
    this.clearTimes();
    (0, _ui.writeModal)('The fox died. RIP <br /> Press the middle button to start');
  },
  ...
  handleUserAction(icon) {
    if (['SLEEP', 'FEEDING', 'CELEBRATING', 'HATCHING', 'POOPING'].includes(this.current)) {
      // do nothing
      return;
    }
